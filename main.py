...
async def process_login(chat_id, bot, message_data, key):
    ...
    signup_data = {
        "current_url": f"https://engineering.careers360.com/download/{ask_me}?utm_source=telegram&utm_medium=rushikesh_8?destination=https://engineering.careers360.com/download/{ask_me}?utm_source=telegram&utm_medium=rushikesh_8&click_location=header",
